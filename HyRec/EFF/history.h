...
#define ANNIHILATION_H_IONIZATION_EFF_TABLE_FILE	"./EFF/Bottom_HIon_HMG.txt"
...
#define ANNIHILATION_ALPHA_EFF_TABLE_FILE		"./EFF/Bottom_LyA_HMG.txt"
...
#define ANNIHILATION_HEATING_EFF_TABLE_FILE		"./EFF/Bottom_Heat_HMG.txt"
