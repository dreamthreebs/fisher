...
#define ANNIHILATION_H_IONIZATION_EFF_TABLE_FILE	"./EFF/Elec_HIon_MODEL1.txt"
...
#define ANNIHILATION_ALPHA_EFF_TABLE_FILE		"./EFF/Elec_LyA_MODEL1.txt"
...
#define ANNIHILATION_HEATING_EFF_TABLE_FILE		"./EFF/Elec_Heat_MODEL1.txt"
