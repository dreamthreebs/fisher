...
#define ANNIHILATION_H_IONIZATION_EFF_TABLE_FILE	"./EFF/Phot_HIon_MODEL1.txt"
...
#define ANNIHILATION_ALPHA_EFF_TABLE_FILE		"./EFF/Phot_LyA_MODEL1.txt"
...
#define ANNIHILATION_HEATING_EFF_TABLE_FILE		"./EFF/Phot_Heat_MODEL1.txt"
