...
double rec_TLA_dxedlna(double xe, double nH, double H, double TM, double TR, 
                       double F, double fsR, double meR, double ionization_dE_dtdV, double alpha_dE_dtdV);
...
double rec_HMLA_dxedlna(double xe, double nH, double H, double TM, double TR, HRATEEFF *rate_table, 
...
void populateTS_2photon(double Trr[2][2], double *Trv[2], double *Tvr[2], double *Tvv[3], 
                        ...
                        double fsR, double meR, double alpha_dE_dtdV);
